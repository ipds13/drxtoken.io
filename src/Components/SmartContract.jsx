    ...
    <div className=" flex items-center justify-center bg-gray-900 py-5 ">
      <div className="bg-gray-900 rounded-2xl shadow-lg w-full md:w-[70%] lg:w-[50%] xl:w-[40%] mx-4 p-4  shadow-orange-200">
        ...
        <div ref={contentRef} className="flex text-white items-center justify-center text-center">
          Quis id ex labore magna ullamco id aliquip. Proident do id esse qui dolore labore deserunt mollit. Consequat proident nulla voluptate exercitation cillum mollit commodo labore ea aute sint et exercitation ullamco. Velit duis nisi
          deserunt occaecat.
        </div>
        <div className="flex items-center justify-center mt-4">
          <button onClick={handleCopyClick} className="bg-yellow-600 text-white px-4 py-2 rounded-xl">
            Copy
          </button>
        </div>
      </div>
